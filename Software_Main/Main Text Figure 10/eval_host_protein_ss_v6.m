...
function [ke,KC0_r,KC0_nr, KC0_A, mu_estimated_profile,mp_estimated,mu_r_profile,  JNr, JNnr, J_A, JWSum] = eval_host_protein_ss_v6(proteinA_params, f_substrate) 
...
JNr= 0.62*model_p.N_r*model_p.lp_r/model_p.l_e*model_p.Omega_r./(model_p.dm_r./KC0_r + mu_r_profile);
JNnr= 0.62*model_p.N_nr*model_p.lp_nr/model_p.l_e*model_p.Omega_nr./(model_p.dm_nr./KC0_nr + mu_r_profile);
J_A=0.62*model_p.lp_A/model_p.l_e*Omega_A./(model_p.dm_A./KC0_A+mu_r_profile);
