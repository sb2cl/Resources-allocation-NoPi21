...
problem.f='CostF_Mu_ss_wildtype_mp5';    %script with the cost function to optimize

problem.x_L=[100,3,3,3,4,0.02,0.77]; % minimum expected values for ku_r, ku_nr, kb_r, kb_nr,omega_r, omega_nr, Phi_t
problem.x_U=[135,10,15,15,6,0.04,0.83]; %  maximum expected values, Phi_t
...
model_p.Phi_t = Results.xbest(1,7); % Average transcription rate for non-ribosomal proteins  (1/min)      
...
[ke,KC0_r,KC0_nr, mu_estimated_profile,mp_estimated,mu_r_profile] = eval_Mu_ss_wildtype_mp5(Results.xbest); 
