...
Mean_Jk_non_ribosomal2= mean(a_ratio_non_ribosomal)
STD_Jk_non_ribosomal=std(a_ratio_non_ribosomal)
...
Mean_Jk_ribosomal2= mean(a_ratio_ribosomal)
STD_Jk_ribosomal=std(a_ratio_ribosomal)
...
plot(a_ratio_non_ribosomal_sorted,'b.','MarkerSize',10)
 xlabel('Non-ribosomal proteins','FontSize',Fontsize,'Interpreter','latex'), ylabel('$\left.J_k\right|_{r=1}$','FontSize',Fontsize,'Interpreter','latex')
 grid on
 ax = gca;
 ax.FontSize = 16;
subplot(222)
plot(a_ratio_ribosomal_sorted,'b.','MarkerSize',10)
 xlabel('Ribosomal proteins','FontSize',Fontsize,'Interpreter','latex'), ylabel('$\left.J_k\right|_{r=1}$','FontSize',Fontsize,'Interpreter','latex')
 grid on
 ax = gca;
 ax.FontSize = 16;
%  subplot(233)
...
% exportgraphics(f1,'../images_def/J_sorted.png','Resolution',300)

f2 = figure(2);
subplot(121)
plot(cumsum_a_ratio_non_ribosomal_sorted,'b.','MarkerSize',15)
hold on
fplot(@(x)0.95*cumsum_a_ratio_non_ribosomal_sorted(end),[1 length(cumsum_a_ratio_non_ribosomal_sorted)],'LineWidth',2,'Color','r','LineStyle','-')
fplot(@(x)0.99*cumsum_a_ratio_non_ribosomal_sorted(end),[1 length(cumsum_a_ratio_non_ribosomal_sorted)],'LineWidth',2,'Color','g','LineStyle','-')
%fplot(0.99*cumsum_a_ratio_non_ribosomal_sorted(end)*ones(length(cumsum_a_ratio_non_ribosomal_sorted)),'g-')
 xlabel('Non-ribosomal proteins','FontSize',Fontsize,'Interpreter','latex'), ylabel('CumSum $\left.J_k\right|_{r=1}$','FontSize',Fontsize,'Interpreter','latex')
 grid on
 ax = gca;
 ax.FontSize = 16;
 hold off
...
hold on
fplot(@(x)0.95.*cumsum_a_ratio_ribosomal_sorted(end),[1 length(cumsum_a_ratio_ribosomal_sorted)],'LineWidth',2,'Color','r','LineStyle','-')
fplot(@(x)0.99.*cumsum_a_ratio_ribosomal_sorted(end),[1 length(cumsum_a_ratio_ribosomal_sorted)],'LineWidth',2,'Color','g','LineStyle','-')
...
%plot(0.99*cumsum_a_ratio_ribosomal_sorted(end)*ones(length(cumsum_a_ratio_ribosomal_sorted)),'g-')
 xlabel('Ribosomal proteins','FontSize',Fontsize,'Interpreter','latex'), ylabel('CumSum $\left.J_k\right|_{r=1}$','FontSize',Fontsize,'Interpreter','latex')
 grid on
 ax = gca;
 ax.FontSize = 16;
 hold off
...
%  exportgraphics(f2,'../images_def/CumSum_J_sorted.png','Resolution',300)
...
plot(log10(a_ratio_non_ribosomal_sorted),'b.','MarkerSize',15)
 xlabel('Non-ribosomal proteins','FontSize',Fontsize,'Interpreter','latex'), ylabel('$\log_{10}{\left.J_k\right|_{r=1}}$','FontSize',Fontsize,'Interpreter','latex')
 grid on
 ax = gca;
 ax.FontSize = 16;
subplot(222)
plot(log10(a_ratio_ribosomal_sorted),'b.','MarkerSize',15)
 xlabel('Ribosomal proteins','FontSize',Fontsize,'Interpreter','latex'), ylabel('$\log_{10}{\left.J_k\right|_{r=1}}$','FontSize',Fontsize,'Interpreter','latex')
 grid on
 ax = gca;
 ax.FontSize = 16;
%  subplot(233)
...
%   exportgraphics(f4,'../images_def/LOG_J_sorted.png','Resolution',300)
  
FontSize=16;
  f5 = figure(5); 
subplot(211)
plot(log10(a_ratio_non_ribosomal_sorted./Length_proteins_non_ribosomal(a_ratio_non_ribosomal_sorted_index)),'Marker','s','MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',5,'LineStyle','none')
 xlabel('Non-ribosomal protein-coding gene $\sharp$','Interpreter','latex','FontSize',FontSize+2), ylabel('$\left.\log_{10}{\frac{J_k}{l_{pk}}}\right|_{r=1}$ ','Interpreter','latex','FontSize',FontSize+2)
 grid on
 ax = gca;
 ax.FontSize = FontSize;
subplot(212)
plot(log10(a_ratio_ribosomal_sorted./Length_proteins_ribosomal(a_ratio_ribosomal_sorted_index)),'Marker','s','MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',5,'LineStyle','none')
 xlabel('Ribosomal protein-coding gene $\sharp$','Interpreter','latex','FontSize',FontSize+2), ylabel('$\left.\log_{10}{\frac{J_k}{l_{rk}}}\right|_{r=1}$ ','Interpreter','latex','FontSize',FontSize+2)
 grid on
 ax = gca;
 ax.FontSize = FontSize;
%  subplot(236)
...
%   exportgraphics(f5,'../images_def/LOG_J_sorted2.png','Resolution',300)
...
% bins = [-6:0.2:1];
% nbins=40;
% %h1 = histfit(log10(a_ratio_non_ribosomal_sorted./Length_proteins_non_ribosomal(a_ratio_non_ribosomal_sorted_index)),nbins,'normal'); %'BinMethod','sturges'
% h1 = histfit(log10(a_ratio_non_ribosomal_sorted),nbins,'normal'); %'BinMethod','sturges'
% 
% h1(1).FaceColor = 'r';
% h1(2).Color ='r';
% % h1 = histogram(log10(a_ratio_non_ribosomal_sorted./Length_proteins_non_ribosomal(a_ratio_non_ribosomal_sorted_index)),nbins,'LineStyle','none','LineWidth',2,'EdgeColor','r','FaceColor','r','poisson'); %'BinMethod','sturges'
% % h1.Normalization = 'count'; % 'probability';
% [pdca1,gn1,gl1] = fitdist(log10(a_ratio_non_ribosomal_sorted./Length_proteins_non_ribosomal(a_ratio_non_ribosomal_sorted_index)),'Normal')
% hold on
% % h2 = histogram(log10(a_ratio_ribosomal_sorted./Length_proteins_ribosomal(a_ratio_ribosomal_sorted_index)),bins,'LineStyle','none','LineWidth',2,'EdgeColor','b','FaceColor','b','poisson');
% % h2.Normalization = 'count'; %'probability';
% 
% %h2 = histfit(log10(a_ratio_ribosomal_sorted./Length_proteins_ribosomal(a_ratio_ribosomal_sorted_index)),nbins,'ev');
% h2 = histfit(log10(a_ratio_ribosomal_sorted),nbins,'normal'); %'BinMethod','sturges'
% h2(1).FaceColor = 'b';
% h2(2).Color ='b';
% legend('Non-ribosomal protein-coding genes', 'Ribosomal protein-coding genes')
% ylabel(' $\sharp$ protein-coding genes','Interpreter','latex','FontSize',FontSize+2), xlabel('$\left.\log_{10}{J_k/l_{rk}}\right|_{r=1}$ ','Interpreter','latex','FontSize',FontSize+2)
%  grid on
%  ax = gca;
%  ax.FontSize = FontSize;
